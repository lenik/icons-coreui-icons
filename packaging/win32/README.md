...
.\build.ps1 -Name icons-coreui-icons -Version 1.2.3
```
...
```
<project>/.config/icons-coreui-icons/<packaging>.build-host
$HOME/.config/icons-coreui-icons/<packaging>.build-host
```
...
user: builder
shell: powershell
build_dir: C:/build/icons-coreui-icons
```
